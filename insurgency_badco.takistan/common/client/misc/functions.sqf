...
casePickup = {
	...
	_cases = nearestObjects[getPosATL player,["suitcase"], 2];
	...
	_cache remoteExecCall ["createIntel",2, false];
	"New intel received on the location of an ammo cache. A marker has been added to the map." remoteExecCall ["hint",-2, false];
};
