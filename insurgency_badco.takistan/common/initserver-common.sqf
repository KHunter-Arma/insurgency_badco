...
MHQ_undeploy_block = false;
publicVariable "MHQ_undeploy_block";

"MHQ_undeploy_block" addPublicVariableEventHandler {
...
call compile preprocessFileLineNumbers "common\server\AI\paradrop\init.sqf";
...
/* 
	Note from Hunter: IED detection script is obsolete. Use @EOD mod instead.
...
cleanupVics = [];
clearWeaponCargoGlobal stuffbox;
clearItemCargoGlobal stuffbox;
clearMagazineCargoGlobal stuffbox;
clearBackpackCargoGlobal stuffbox;
